...
@php
    $defaultNavItems = [
        ...
        ['label' => 'Chat', 'href' => route('apps.assets.chat'), 'icon' => 'chat-bubble-left-right', 'description' => 'KI-Chat mit OpenWebUI und MCP-Server-Unterstützung', 'buttonText' => 'Chat öffnen'],
        ...
        ['label' => 'Rechnungen', 'href' => route('apps.assets.rechnungen'), 'icon' => 'banknotes', 'description' => 'D3-Rechnungsanalysen (Vision-Cache) einsehen und ausstehende Analysen starten', 'buttonText' => 'Rechnungen anzeigen', 'permission' => 'manage-app-assets'],
