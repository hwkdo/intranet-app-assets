...
title('Assets - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die Assets App',
    'status' => 'active',
...
?>
<div>
<x-intranet-app-assets::assets-layout heading="Beispiel-Seite" subheading="Demonstration der Assets-Funktionalität">
    <flux:card>
