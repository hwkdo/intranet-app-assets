...
new class extends Component
{
    ...
    {
        $value = auth()->user()?->settings->app->assets->dashboard['widgetItemCounts']['abgelehnte-uebergaben']
            ?? auth()->user()?->settings->dashboard->personalGrid?->widgetItemCounts['abgelehnte-uebergaben']
            ?? 5;
